...
# Hauptteil des Skripts zum Laden der Daten aus JSON-Dateien
if __name__ == "__main__":
    try:
        ...
        resolution = 0.05
        sr = 5
        max_translation = 20  # Anpassbarer Wert
        rotation_steps = 72  # Feinere Rotationssuche
        ...
        plt.title('Überlagerung (Gelb = Ähnlichkeitsfeld alter Scan, Helle Punkte = Transformierter neuer Scan)')
